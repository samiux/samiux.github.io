...
有趣的是，LDL 并不是越低越好，有研究显示 LDL 介乎 2.0 - 4.0mmol/L 之间的死亡风险相对较低。若果 LDL 低于 2.0mmol/L 的风险相对显注地增加，越低风险越高，更值得注意的是其风险增加的幅度还比高于 4.0mmol/L 的还要高。当然这个数据必须同时亦要与多项数据一起来评估的。
