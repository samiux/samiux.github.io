...
The target AP should be Wifi5 and below and with WPA/WPA2.  Once you get the mac address of the target AP, you need to remove all the ":" from the address.  From ```00:0a:95:9d:68:16``` to ```000a959d6816``` and save to a file namely ```ap.txt```.
