...
However, this method does not work on [TP-Link Deco X20](https://www.tp-link.com/hk/home-networking/deco/deco-x20/?utm_medium=select-local) Mesh Wifi Router (Wifi6 with WPA3).  All known attack methods has been tried on the Deco X20 but failed including PMKID attack (tested on March 19, 2020) and KR00K attack (CVE-2019-15126) (tested on March 21, 2020).  KR00K attack fails as Deco X20 is using Qualcomm IPQ8070 chipset instead of Broadcom.  I think PMKID attack cannot be working on Wifi6 with WPA3 for other brand names too.
