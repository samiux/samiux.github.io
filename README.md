...
有专家认为在理论上，当在细胞自噬的过程中，如果摄取了脂肪是不会打断或终止细胞自噬的，因为脂肪基本上不会刺激胰岛素的分泌。但另一方面是，脂肪是一种会提供能量的食物，而细胞自噬是需要在缺乏能量的情况下才能激活的。这显然是一个矛盾点，那你就需要进行一次 n=1 的实验了。
...
在酮流感或生酮状态下，若果摄取过量或不足的盐份，或会引致腹泻，但每个人的情况有可能不尽相同。另外，摄取过量的维生素C亦有可能会出现相同现象。
