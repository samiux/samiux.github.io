...
但无论如何，硬体数据最为准确，安装 NetMonster App 来捡查硬体数据最为实际。
...
「麦当劳」App、 HK Express App 及 Chrome 并不兼容 EMUI 14.2 及 HarmonyOS 4.2。有时 Aurora Store 会显示他国文字，但迟一些时间就回復了。但如果 Aurora Store 更新到 4.6.0 就没有那个问题了。

今天 (二零二四年九月廿九日) EMUI 14.2 的华为应用市场更新了已在 microG Project 安装的 microG 为 hw 版本，暂时已知九巴 App 不能显示路线地图，其他的正在观察中。暂时不会转回 microG 官方版本。
