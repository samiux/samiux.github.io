...
今天 (二零二四年九月廿九日) 华为应用市场更新了已在 microG Project 安装的 microG 为 hw 版本，暂时已知九巴 App 不能显示路线地图；至于「麦当劳」App，HK Express App 及 Chrome 已经能使用无误了。但 Google Authenticator 并不能使用扫描器。其他的正在观察中。暂时不会转回 microG 官方版本。
