...
- A more powerful CPU and more memory are required.  You will experience slow browsing speed of web pages when using Intel i7-4650U CPU (2 core 4 Threading).  ClamAV uses at least 3GB RAM.  
